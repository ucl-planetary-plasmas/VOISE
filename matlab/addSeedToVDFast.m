function VD = addSeedToVDFast(VD, S)
% function VD = addSeedToVDFast(VD, S)
...
%
% $Id: addSeedToVDFast.m,v 1.1 2009/02/08 21:07:18 patrick Exp $
%
% Copyright (c) 2008 
...
tic
VD = updateNeighboursListsFromVoronoin(VD);
toc
%pause
end
...
mus = (VD.x-VD.Sx(k)).^2           +(VD.y-VD.Sy(k)).^2;
...
lambda = VD.Vk.lambda(VD.Sy(k), VD.Sx(k));
