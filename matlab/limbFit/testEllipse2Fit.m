...
if 0
r = ellipse(t,p);
plot(t,r,'o',t,sqrt(Sx0.^2+Sy0.^2),'x')
end
...
if 0
xp = a*(1+pc*(0.5-rand(1,ns))).*cosd(t);
yp = b*(1+pc*(0.5-rand(1,ns))).*sind(t);
Sx = zeros(size(t));
Sy = zeros(size(t));
Q = [cosd(t0), -sind(t0); ...
     sind(t0), cosd(t0)];
...
p(1:4),180/pi*p(5));
xc = p(1); yc = p(2); a = p(3); b = p(4); t0 = 180/pi*p(5);
