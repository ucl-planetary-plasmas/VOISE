function params = testReadAPISLevel1(filename)
...
if 0
% Arcsec pr/hr
raJup = (raJup - raAPER) / params.HST.PIXSIZE(1) * 3600;
decJup = (decJup - decAPER) / params.HST.PIXSIZE(2) * 3600;
end
...
axis xy
subplot(312)
imagesc(params.x + 1,params.y + 1, params.W)
axis xy
...
xAPER = params.HST.iCD1_1 * (raAPER - AR0) + params.HST.iCD1_2 ...
    * (decAPER - DEC0) + X0;
yAPER = params.HST.iCD2_1 * (raAPER - AR0) + params.HST.iCD2_2 ...
    * (decAPER - DEC0) + Y0;

xJup = params.HST.iCD1_1 * (raJup - AR0) + params.HST.iCD1_2 ...
    * (decJup - DEC0) + X0;
yJup = params.HST.iCD2_1 * (raJup - AR0) + params.HST.iCD2_2 ...
    * (decJup - DEC0) + Y0;

if exist('raimcce', 'var') && exist('decimcce', 'var')
ximcce = params.HST.iCD1_1 * (raimcce - AR0) + params.HST.iCD1_2 ...
    * (decimcce - DEC0) + X0;
yimcce = params.HST.iCD2_1 * (raimcce - AR0) + params.HST.iCD2_2 ...
    * (decimcce - DEC0) + Y0;
end
...
arRenee = params.HST.CD1_1 * (xrenee - X0) + params.HST.CD1_2 ...
    * (yrenee - Y0) + AR0;
decRenee = params.HST.CD2_1 * (xrenee - X0) + params.HST.CD2_2 ...
    * (yrenee - Y0) + DEC0;
...
imageDataAlt = info.Image;
imageDataAlt;
pDataAlt = info.PrimaryData;
pDataAlt;
tableDataAlt = info.BinaryTable;
tableDataAlt;
