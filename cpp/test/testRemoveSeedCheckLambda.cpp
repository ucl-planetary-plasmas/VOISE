...
// Load VD
std::string path = "../test/resources/";
...
* seed to each pixel is the one held in its \f$ \lambda \f$ matrix entry.
*/
TEST_CASE("Check whether the removeSeed method correctly recalculates the lambda"
          " matrix"){
